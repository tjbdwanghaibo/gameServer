...
public final class HumanGlobalServiceImpl extends RPCImpIBase {
	...
	public Object getMethodFunction(Service service, int methodKey) {
		...
		switch (methodKey) {
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_CHANGENAME_LONG_STRING: {
				return (JowFunction2<Long, String>)serv::changeName;
			}
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_FINDHUMAN_STRING: {
				return (JowFunction1<String>)serv::findHuman;
			}
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_GETHUMANINFO_LIST: {
				return (JowFunction1<List>)serv::getHumanInfo;
			}
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_GETNEARBYPLAYER_LONG: {
			...
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_GETONLINES_LIST: {
			...
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_HUMANUPDATE_PARMS: {
			...
			case EnumCall.ORG_JOW_CENTRALSRV_HUMANGLOBALSERVICE_SENDMSG_LONG_INT_CHUNK: {
