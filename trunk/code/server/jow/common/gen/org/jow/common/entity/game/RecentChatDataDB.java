...
@JowGenFile
public final class RecentChatDataDB extends EntityBase {
	
	public static final String tableName = "game_recent_chat";
	...
	public RecentChatDataDB() {
		super();
	}

	public RecentChatDataDB(Record record) {
		super(record);
	}
