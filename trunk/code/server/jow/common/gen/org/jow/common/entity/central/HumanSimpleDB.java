...
@JowGenFile
public final class HumanSimpleDB extends EntityBase {
	
	public static final String tableName = "centralsrv_human";
	...
	public HumanSimpleDB() {
		super();
	}

	public HumanSimpleDB(Record record) {
		super(record);
	}
